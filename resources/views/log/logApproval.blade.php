    ...
    <div class="content">
        <div class="container-fluid" display="none">
            <div class="card">
                ...
                <div class="card-block" id="filterLogApproval">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-3 xs-mb-15">
                                        ...
                                        <input type="text" id="user_filter" name="user_filter"
                                            class="form-control input-sm" placeholder="Search User" autocomplete="off">
                                    </div>
                                    <div class="col-sm-3 xs-mb-15">
                                    ...
                                    <div class="col-sm-3 xs-mb-15">
                                        ...
                                        <input type="text" id="table_name_filter" name="table_name_filter"
                                            class="form-control input-sm" placeholder="Search Table Name"
                                            autocomplete="off">
                                    </div>
                                    <div class="col-sm-3 xs-mb-15">
                                        <label for="action_filter">Action</Title></label>
                                        <input type="text" id="action_filter" name="action_filter"
                                            class="form-control input-sm" placeholder="Search by Action" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    {{-- <div class="col-sm-3 xs-mb-15">
                                        ...
                                        <input type="text" id="method_filter" name="method_filter"
                                            class="form-control input-sm" placeholder="Search by Method" autocomplete="off">
                                    </div> --}}
                                    <div class="col-sm-3 xs-mb-15">
                                        <label for="log_filter">Log</Title></label>
                                        <input type="text" id="log_filter" name="log_filter"
                                            class="form-control input-sm" placeholder="Search Log" autocomplete="off">
                                    </div>
                                    <div class="col-sm-3 xs-mb-15">
        ...
        <div class="container-fluid pb-5" id="reportLogApprovalResult">
            <div class="card header-info-filter">
                <div class="card-body ">
                    <div class="button-row" style="display: flex; justify-content:end">
                    </div>

                    <table id="reportLogApprovalTable" width="100%" class="table table-striped nowrap">
                        <thead class="mt-30">
                            <tr>
                                <th scope="col">No</th>
...
@section('scripts')
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#reportLogApprovalTable').DataTable({
                "responsive": false,
                "paging": true,
                "scrollX": true,
                "scrollY": false,
            ...
            $('#submitSearch').click(function(e) {
                ...
                if ($.fn.DataTable.isDataTable('#reportLogApprovalTable')) {
                    table.destroy();
                }
